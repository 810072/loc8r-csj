...
const apiOptions = {
  server: 'https://loc8r-csj.onrender.com'
};
  ...
  res.render('location-info', {
    ...
    sidebar: {
      context: 'is on Loc8r because it has accessible wifi and \
        space to sit down with your laptop and get some work done 2022810072 최상진',
...
const renderHompage = (req, res, responseBody) => {
  ...
  res.render('locations-list', {
    ...
    Let Loc8r help you find the place you're looking for. 2022810072 최상진" ,
...
const showError = (req, res, status) => {
  ...
  if (status === 404) {
    ...
    content = "Oh dear. Looks like you can't find this page. Sorry 2022810072 최상진";
  } else {
    title = `${status}, something's gone wrong`;
    content = 'Something, somewhere, has gone just a little bit wrong 2022810072 최상진';
  }
  res.status(status);
